...
const TAB_CONFIG = [
  ...
  { name: 'visas',    label: 'التأشيرات', icon: 'document-text-outline', activeIcon: 'document-text'  },
  { name: 'packages', label: 'الباقات',   icon: 'map-outline',           activeIcon: 'map'            },
  { name: 'flights',  label: 'الطيران',   icon: 'paper-plane-outline',   activeIcon: 'paper-plane'    },
  { name: 'account',  label: 'حسابي',    icon: 'person-outline',        activeIcon: 'person'         },
];
...
// ─── Classic layout with premium custom tab bar ───────────────────────────────
